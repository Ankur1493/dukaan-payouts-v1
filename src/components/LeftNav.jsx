...
const LeftNav = () => {
  return (
    <div className='fixed top-0 left-0 h-full w-[224px] flex-col flex-shrink-0 bg-[#1E2640] text-white py-[16px] px-[10px]'>
      ...
      {
        leftNavTabs.map(tab => (
          <div className={`cursor-pointer rounded-[4px] py-[12px] px-[16px] w-full flex text-white  ${tab.tabName === "Payments" ? "rounded-[4px] bg-white bg-opacity-10" : ""}`} key={tab.tabName}>
