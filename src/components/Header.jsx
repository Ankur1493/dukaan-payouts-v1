...
const Header = () => {
  return (
    <div className="w-[calc(100vw-224px)] bg-white flex items-center justify-between h-[50px]  ml-[224px] pl-[35px] pr-[45px] py-[32px]">
      <div className='flex'>
        <div className='text-[20px] font-normal'>Payouts</div>
        <div className='text-[14px] flex font-thin ml-[20px] justify-center cursor-pointer items-center'>
